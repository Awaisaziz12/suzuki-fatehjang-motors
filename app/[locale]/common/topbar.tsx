...
const TopBar = () => {
  return (
    <div className="w-100 bg-dark text-white small border-bottom">
      <div className="container py-1">

        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">

          {/* LEFT SIDE */}
          <div className="d-flex flex-wrap gap-2 gap-md-3 text-center text-md-start">

            <span className="d-flex align-items-center gap-1">
              📞 <span className="text-break">{Constants.PHONE}</span>
            </span>

            <span className="d-flex align-items-center gap-1">
              ✉️ <span className="text-break">info@suzukifatehjang.com</span>
            </span>
